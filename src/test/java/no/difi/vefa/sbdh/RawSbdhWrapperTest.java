...
public class RawSbdhWrapperTest {

    private RawSbdhFactory sbdhFactory = (RawSbdhFactory) EnvelopeFactoryFactory.rawSbdhFactory();

    @Test
    public void simple() throws EnvelopeException, IOException {
        sbdhFactory.wrap(HeaderHelper.toSbdh(Header.newInstance()
                ...
                new AsicToXmlWrapper(getClass().getResourceAsStream("/sample-asic.asice")),
                System.out);
    }
}
